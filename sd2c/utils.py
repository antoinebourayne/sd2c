...
class SSHParams:
    """
    This class contains all the values and parameters for the module.
    It is initialized with a set of arguments (ex: with a command parser), cf the main.
    Most of the necessary variables are set with default values.
    """
